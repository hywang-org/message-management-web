...
import com.flash.message.entity.order.ResOrder;
...
public interface ResOrderMapper {
     ...
     * @mbg.generated 2019-10-10
     */
    int insert(ResOrder record);

    /**
     *
     * @mbg.generated 2019-10-10
     */
    int insertSelective(ResOrder record);

    /**
     *
     * @mbg.generated 2019-10-10
     */
    ResOrder selectByPrimaryKey(Long id);

    /**
     *
     * @mbg.generated 2019-10-10
     */
    int updateByPrimaryKeySelective(ResOrder record);

    /**
     *
     * @mbg.generated 2019-10-10
     */
    int updateByPrimaryKey(ResOrder record);
